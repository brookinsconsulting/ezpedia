...
<div class="block">
<label for="id1">{"Please login to eZpedia using this form or follow this <a href='/user/register/'>link</a> to create an account"|i18n("design/standard/user",'User name')}</label><div class="labelbreak"></div>
</div>
...
{section show=true()} {* ezini( 'SiteSettings', 'LoginPage' )|eq( 'custom' ) *}
