...
{section show=$validation.processed}
        <div class="message-warning">
            <h2><span class="time">[{currentdate()|l10n( shortdatetime )}]</span> {'Missing or invalid input'|i18n( 'extension/authorcontact' )}</h2>
            <ul>
...
{* Contact *}
<div class="block">
    <label>{'Contact'|i18n( 'extension/authorcontact' )}:</label>
    {$author_name}
</div>
...
<div class="block">
    <label>{'Name'|i18n( 'extension/authorcontact' )} <span class="required">({'required'|i18n( 'extension/authorcontact' )})</span>:</label>
...
{* Email address *}
<div class="block">
    <label>{'E-mail'|i18n( 'extension/authorcontact' )} <span class="required">({'required'|i18n( 'extension/authorcontact' )})</span>:</label>
    {section show=$current_user.is_logged_in}
...
{* Subject *}
<div class="block">
    <label>{'Subject'|i18n( 'extension/authorcontact' )} <span class="required">({'required'|i18n( 'extension/authorcontact' )})</span>:</label>
        <input class="box" type="text" size="25" name="Subject" value="{$subject}" />
</div>

{* Message *}
<div class="block">
    <label>{'Message'|i18n( 'extension/authorcontact' )} <span class="required">({'required'|i18n( 'extension/authorcontact' )})</span>:</label>
...
<div class="block">
	<input class="button" type="submit" name="SendButton" value="{'Send a message'|i18n( 'extension/authorcontact' )}" />
	<input class="button" type="submit" name="CancelButton" value="{'Cancel'|i18n( 'extension/authorcontact' )}" />
</div>
