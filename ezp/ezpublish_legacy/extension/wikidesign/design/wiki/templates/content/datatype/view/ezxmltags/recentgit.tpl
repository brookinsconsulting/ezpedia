{def $feedurl0="http://github.com/ezsystems/ezpublish-legacy/commits/master.atom"
     $feedresults=array()
     $issue=false()}
...
{* $feedresults|attribute(show,1) *}
  ...
  <div class="content-view-children" style="padding-left: 1.37%; padding-bottom: 10px;">
   ...
   <span class="rss-link"><a href="{$feedurl}"><img src={'images/icons/feed/feed-icon-16x16.png'|ezdesign} alt="github.com/ezsystems/ezpublish-legacy commit log rss feed"/></a></span>
    ...
    <div style="list-style-type: none;font-size: xx-small; padding-bottom:4px;">
     ...
     <span style="font-size: xx-small;"> 
	  {set $issue=getIssueFromGitCommitMessage( $child )}
